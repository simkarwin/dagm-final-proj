...
class CrossAttentionLayer(nn.Module):
    ...
    def forward(
        ...
        output = self.norm(
            text_features + self.dropout(attended_features)
        )
...
class FloodNetVQAModel(nn.Module):
    def __init__(
        ...
        # Remove avgpool and fc to preserve spatial features
        ...
        # Unfreeze last block
        for param in self.image_encoder[-1].parameters():
    ...
    def forward(
        ...
        # Use CLS token after cross-attention
